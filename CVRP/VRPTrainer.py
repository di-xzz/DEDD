...
#             selected_node_student1,selected_node_student2,selected_flag_student1,selected_flag_student2
                ...
                loss_mean1 = loss_node1
                loss_mean2 = loss_node2
                loss_mean = loss_mean1 + loss_mean2
                if loss_mean1 > loss_mean2:
        ...
        loss_mean1 = torch.tensor(loss_list).mean()

        return 0,0, loss_mean1.item()