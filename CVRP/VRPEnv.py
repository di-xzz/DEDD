...
class VRPEnv:
    ...
    def vrp_whole_and_solution_subrandom_shift_V2inverse(self, solution):
        ...
        end_with_depot = end_with_depot.cuda()
        ...
        double_solution = double_solution.cuda()
    ...
    def sampling_subpaths(self, problems, solution, length_fix=False):
        ...
        double_solution_demand = problems[:offset_index,:,2][a[:,None].repeat(1,double_solution.shape[1]),double_solution[:offset_index,:,0] ]
